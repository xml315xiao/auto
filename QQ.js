...
//调用
/* var pwd = WScript.Arguments.Item(0);
var code = WScript.Arguments.Item(1);
var salt = eval("'" + WScript.Arguments.Item(2) + "'");
WScript.Echo(XIAOKU.Encryption.getEncryption(pwd,salt,code)); */
var params = process.argv;
var password = params[2];
var code = params[3];
var salt = eval("'" + params[4] + "'");

console.log(XIAOKU.Encryption.getEncryption(password, salt, code));
